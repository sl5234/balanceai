...
from balanceai_backend.journals.merchant_cache import load_merchant_context_cache, save_merchant_context_cache
...
from balanceai_backend.prompts.extract_journal_entry_prompt import categorize_journal_entry_prompt, extract_journal_entries_prompt
...
def extract_journal_entries_from_bank_statement_transaction(transaction: Transaction) -> list:
    ...
    logger.info("extract_journal_entries_from_bank_statement_transaction LLM raw response: %s", response)
